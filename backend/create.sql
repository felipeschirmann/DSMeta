create table tb_sales (id bigint generated by default as identity, amount float8, date date, deals integer, seller_name varchar(255), visited integer, primary key (id));
